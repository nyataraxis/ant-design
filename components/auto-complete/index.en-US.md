...
| children (for customize input element) | customize input element | HTMLInputElement <br /><br /> HTMLTextAreaElement <br /><br /> `any` | `<Input />` |  |
| children (for dataSource) | Data source to auto complete | `any` <br /><br /> `Array<any>` | - |  |
